...
{
    public static class UpdateDepartmentRequestExtension
    {
        public static DepartmentDTO ToDTO(this UpdateDepartmentRequest request)
        {
            var dto = new DepartmentDTO
            {
                id = request.id,
                DepartmentName = request.DepartmentName,
                CompanyRuleId = request.CompanyRuleId,
